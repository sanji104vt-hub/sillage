...
const PILOT_SLUGS = ["dior-2", "ysl-2", "versace-1", "tom-ford-1", "maison-margiela-1", "hermes-3", "guerlain-3", "shiro-1", "aesop-1"];
...
const THIRD_BATCH_SLUGS = new Set([
  ...
  "chanel-1", "paco-rabanne-1", "nautica-1", "ysl-1", "chanel-2", "gucci-1", "dior-3", "calvin-klein-1",
