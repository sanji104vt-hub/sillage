...
const PILOT_SLUGS = ["dior-2", "ysl-2", "versace-1", "maison-margiela-1", "guerlain-3", "shiro-1", "aesop-1"];
const SECOND_BATCH_SLUGS = ["jo-malone-1", "acqua-di-parma-1", "dior-1", "guerlain-2", "dior-4", "mugler-1", "ysl-3", "bvlgari-1", "chanel-4", "tom-ford-2", "creed-1", "diptyque-1", "byredo-1", "tom-ford-3", "le-labo-2", "maison-margiela-2", "giorgio-armani-3", "issey-miyake-1", "versace-4"];
const THIRD_BATCH_SLUGS = new Set([
  "4711-1", "guerlain-1", "dolce-gabbana-1", "hermes-2", "ck-1", "montblanc-1", "azzaro-1",
  "chanel-1", "paco-rabanne-1", "nautica-1", "chanel-2", "gucci-1", "dior-3", "calvin-klein-1",
  "chanel-3", "gucci-2", "jo-malone-2", "marc-jacobs-1", "jo-malone-3", "versace-2", "azzaro-2", "thierry-mugler-1", "giorgio-armani-1", "viktor-rolf-1", "prada-1", "carolina-herrera-1",
]);
