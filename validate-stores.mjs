...
assert(storesForCity("kyoto").length === 21, `Kyoto store count changed: ${storesForCity("kyoto").length}`);
...
assert(stores.length === 68, `Total store count changed: ${stores.length}`);
