...
await expect("/en/brands", 301, "/en/brands/");
await expect("/en/brands/", 200);
await expect("/en/brands/dior", 301, "/en/brands/dior/");
await expect("/en/brands/dior/", 200);
await expect("/en/brands/dior/index.html", 301, "/en/brands/dior/");
await expect("/en/guides/perfume-shopping-kyoto", 301, "/en/guides/perfume-shopping-kyoto/");
await expect("/en/guides/perfume-shopping-kyoto/", 200);
await expect("/en/guides/perfume-shopping-kyoto/index.html", 301, "/en/guides/perfume-shopping-kyoto/");
