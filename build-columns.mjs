...
</style></head><body data-page-type="column" data-column-slug="${esc(article.slug)}" data-column-title="${esc(article.title)}" data-column-category="${esc(category.label)}"><script defer src="/assets/analytics.js"></script><header class="topbar"><a class="logo" href="/">Sillage</a><span class="pr-tag">PR・アフィリエイト広告を含みます</span></header>
