...
<main>
  ...
  <section class="section" id="paths"><div class="wrap"><p class="eyebrow">Explore Sillage</p><h2>Choose how you want to look.</h2><p class="lede">Start with five fragrance pages prepared in English. Additional guides will be added without changing the Japanese site.</p><div class="cards">
    <a class="card path-card" href="/en/fragrances/"><h3>Fragrances</h3><p>Compare ${localizedProducts.length} fragrances with complete English pages by scent family, season, occasion, gender and price band.</p><small>Open catalogue →</small></a>
    <div class="card path-card"><span class="coming">In development</span><h3>Brands</h3><p>Brand profiles with Japanese names, country of origin and official links.</p></div>
    <div class="card path-card"><span class="coming">In development</span><h3>Fragrance Finder</h3><p>A guided route from scent preference to a short list of products.</p></div>
    <div class="card path-card"><span class="coming">In development</span><h3>Guides</h3><p>Practical shopping, testing and wearing guidance for visitors to Japan.</p></div>
    <div class="card path-card"><span class="coming">In development</span><h3>Cities</h3><p>City guides will be published after their shop information is verified.</p></div>
  </div></div></section>
